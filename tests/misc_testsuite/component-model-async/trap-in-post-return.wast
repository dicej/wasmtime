...
;;
;; (Copied from https://github.com/WebAssembly/component-model/blob/6bf50c7230376a6a7667e5341cbff18c1fbda370/test/values/trap-in-post-return.wast)
...
;; TODO: This error message should match the others, but FACT will need to be
;; updated first:
